...
@CucumberOptions(features = "src/test/resources/Features/login.feature", glue = { "step_def" },
		// plugin= {"pretty","html:target/Reports/report.html"},
		// plugin= {"pretty","json:target/Reports/report.json"},
		// plugin= {"pretty","junit:target/Reports/report.xml"},
      //or
         plugin = {"pretty","html:target/Reports/report.html","json:target/Reports/report.json","junit:target/Reports/report.xml"},
		dryRun = false, // it will check mapping between feature & step definition is proper or not
		...
		// publish=true
		tags = "@SmokeTesting" // filtering Scenarios using tags
)
